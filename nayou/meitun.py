...
for i in xrange(14,20):
    ...
    root = 'http://www.ivrfans.cn/meitun/list_57_%d.html' % i
    req = urllib2.urlopen(root)
    html_content = req.read()

    list_urls = re.findall(r'/meitun/.+/\d{3,6}\.html', html_content)
    ...
    for list_url in list_urls:
        ...
        try:
            ...
            if page_req.getcode()==200:
                ...
                page_urls = re.findall(r'/meitun/.+/\d{3,6}_\d{1,3}\.html', page_buf)
                print len(page_urls)
                print page_urls
    ...
    #
                            for pic_url in pic_urls:
                                path = '/media/deepir/DATA/func/sexy_all/meitun'
