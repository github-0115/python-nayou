...
for i in xrange(1,9):
    ...
    root = ''
    if i == 1:
        root = 'http://www.mm131.com/mingxing/'
    else:
        root = 'http://www.mm131.com/mingxing/list_5_%d.html' % i
    print(root)

    req = urllib2.urlopen(root)
    html_content = req.read()

    linkPattern = re.compile(r'http://www.mm131.com/mingxing/\d{1,6}\.html')
            ...
            if req.getcode()==200:
                ...
                for j in range(0, len(page_urls) - 1):
                    ...
                    if j == 0:
                        ...
                        url = 'http://www.mm131.com/mingxing/' + page_urls[j]
                    print url
